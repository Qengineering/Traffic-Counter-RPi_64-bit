...
//----------------------------------------------------------------------------------------
void TMapper::ResetCntAr(void)
{
    for(int i=0;i<80;i++) CntAr[i]=0;
}
//----------------------------------------------------------------------------------------
void TMapper::Execute(std::vector<bbox_t> objs)
{
...
bool TMapper::isAboveAndBelow(const BBox<float> &Loc3, const BBox<float> &Loc4)
{
    double a1 = p2.Y - p1.Y;
    double b1 = p1.X - p2.X;
...
//----------------------------------------------------------------------------------------
void TMapper::CountObjects(TObject &Ob)
{
    if(Ob.Tdone) return;
...
//----------------------------------------------------------------------------------------
bool TMapper::FindObject(const bbox_t& bo, size_t& j)
{
...
//---------------------------------------------------------------------------
std::ostringstream TMapper::GetJSONstring(void)
{
...
//---------------------------------------------------------------------------
void TMapper::MQTTevent(void) //also calling JSONevent
{
